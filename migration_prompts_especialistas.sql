-- Execute esta query no Editor SQL do seu Supabase para criar as colunas de prompts especialistas globais e popular os prompts padrões
...
- Se o cliente solicitar "garçom", "atendente", "ajuda humana" ou similar, you must OBRIGATORIAMENTE executar a tool Chama_garcom antes de responder qualquer texto.
